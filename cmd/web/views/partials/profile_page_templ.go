...
func ProfilePage(
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<!-- Right Panel - Device Config --><div class=\"flex-1 bg-sd-darker\" id=\"main-content\"><div class=\"flex flex-row w-full\"><div class=\"w-32 p-6 flex items-center justify-center text-gray-400\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for i, page := range pages {
				if page.ID == currentPage.ID && i > 0 {
					...
					var templ_7745c5c3_Var3 templ.SafeURL = templ.URL("/instance/" + currentInstance.ID + "/device/" + currentDevice.ID + "/profile/" + currentProfile.ID + "/page/" + pages[i-1].ID)
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(string(templ_7745c5c3_Var3)))
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\" class=\"hover:text-white transition-colors\"><svg class=\"w-8 h-8\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M15 19l-7-7 7-7\"></path></svg></a>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "</div><div class=\"flex-grow p-6 text-center text-gray-400\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<nav class=\"flex justify-center mt-4\"><ul class=\"flex space-x-2\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for i, page := range pages {
				...
				var templ_7745c5c3_Var4 = []any{"px-3 py-2 rounded-lg transition-colors " + cond(page.ID == currentPage.ID, "bg-sd-accent text-white", "bg-sd-light hover:bg-sd-lighter text-gray-300")}
				...
				var templ_7745c5c3_Var5 templ.SafeURL = templ.URL("/instance/" + currentInstance.ID + "/device/" + currentDevice.ID + "/profile/" + currentProfile.ID + "/page/" + page.ID)
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/partials/profile_page.templ`, Line: 68, Col: 30}
				}
			...
			var templ_7745c5c3_Var8 = []any{"px-3 py-2 rounded-lg transition-colors bg-sd-light hover:bg-sd-lighter text-gray-300"}
			...
			templ_7745c5c3_Var10, templ_7745c5c3_Err = templ.JoinStringErrs("/api/page/create?instanceId=" + currentInstance.ID + "&deviceId=" + currentDevice.ID + "&profileId=" + currentProfile.ID)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/partials/profile_page.templ`, Line: 76, Col: 141}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var10))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "\" hx-target=\"body\" hx-swap=\"innerHTML\">+</a></li></ul></nav></div><div class=\"w-32 p-6 flex items-center justify-center text-gray-400\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for i, page := range pages {
